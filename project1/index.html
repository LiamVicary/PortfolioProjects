...
<html lang="en">
  ...
  <body>
          ...
          <div class="modal-body">
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td class="text-end" id="modalCountryCurrency">Currency</td>
              </tr>
              <!--Modal Row-->
              <tr>
                <td class="text-center">
                  <i class="fa-solid fa-border-all fa-xl text-success"></i>
                </td>
                <td>Borders</td>
                <td class="text-end" id="modalCountryBorders">—</td>
              </tr>
            </table>
          </div>
        ...
        <div class="modal-content shadow">
          ...
          <div class="modal-body">
            ...
            <div class="row text-center">
              <div class="col" id="modalForecastDay1">
                <p class="mb-1">
              ...
              <div class="col" id="modalForecastDay2">
                <p class="mb-1">
              ...
              <div class="col" id="modalForecastDay3">
                <p class="mb-1">
    ...
    >
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content shadow">
          ...
          <!-- we show the line “1 USD = … EUR” here -->
          <div class="px-3 pt-2">
            <small id="modalOtherLocationName" class="text-muted"></small>
          </div>

          <div class="modal-body">
            <!-- wrap in a form so your JS can catch the submit -->
            <form id="currencyForm">
              ...
              <div class="mt-3 text-center">
                <h6 id="conversionResult">…</h6>
              </div>
            </form>
          </div>

          <div class="modal-footer">
            <!-- no need for an extra “convert” button; submit on Enter or add a button here -->
            <button
              type="submit"
              form="currencyForm"
    ...
    <!-- ________________________________________NEWS MODAL________________________________________ -->
    <div
      id="newsModal"
      class="modal fade"
      data-bs-backdrop="false"
      ...
      >
        <div class="modal-content shadow">
          ...
          <div class="modal-body" id="newsModalBody">
            <!-- JS will inject a list of the top 3 articles here -->
